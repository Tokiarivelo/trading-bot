"""Trend-follow zone strategy for XAUUSD (M1 entries, M5 trend filter) —
scalp tier.
...
Merges two existing families instead of extending either in isolation:
  ...
  - `rbr_dbd_zones_scalp_xauusd_v1.py`'s zone geometry (`_detect_zones`,
...
class TrendFollowZonesScalpXauusd:
    def __init__(self) -> None:
        self.spec = StrategySpec(
            name="trend_follow_zones_scalp_xauusd",
            version=1,
            symbols=("XAUUSD",),
            entry_timeframe="M1",
