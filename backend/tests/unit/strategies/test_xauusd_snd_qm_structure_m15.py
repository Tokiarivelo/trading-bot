"""Unit tests for `xauusd_snd_qm_structure_m15_v3.py` (the ACTIVE version) —
XAUUSD S&D V1/V2 + Quasimodo + market-structure strategy, M15 Intraday preset.
Zone timeframe is H1, resampled in-strategy from M15 (4 M15 bars per bucket)."""
...
from src.strategies.generated.xauusd_snd_qm_structure_m15_v3 import (
