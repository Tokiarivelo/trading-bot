"""Unit tests for `xauusd_snd_qm_structure_h1_v3.py` (the ACTIVE version) —
XAUUSD S&D V1/V2 + Quasimodo + market-structure strategy, H1 Short Swing
preset. Zone timeframe is H4, resampled in-strategy from H1 (4 H1 bars per
bucket)."""
...
from src.strategies.generated.xauusd_snd_qm_structure_h1_v3 import (
