...
#
# `RbrDbdZonesScalpBtcusdV2._detect_zones_cached` is a timestamp-keyed
...
def test_incremental_cache_matches_full_recompute_every_step() -> None:
    ...
    (`RbrDbdZonesScalpBtcusdV2._detect_zones_cached`, called on one
    ...
    params = mod.RbrDbdZonesScalpBtcusdV2().spec.params
    incremental = mod.RbrDbdZonesScalpBtcusdV2()
...
def test_incremental_cache_reprocesses_far_fewer_bars_than_full_recompute() -> None:
    ...
    with pytest.MonkeyPatch.context() as mp:
        ...
        bars_walked.clear()
        cold = mod.RbrDbdZonesScalpBtcusdV2()
