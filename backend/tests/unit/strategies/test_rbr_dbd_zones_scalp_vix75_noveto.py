...
#
# `RbrDbdZonesScalpVix75Noveto._detect_zones_cached` is a timestamp-keyed
...
def test_incremental_cache_matches_full_recompute_every_step() -> None:
    ...
    (`RbrDbdZonesScalpVix75Noveto._detect_zones_cached`, called on one
    ...
    params = mod.RbrDbdZonesScalpVix75Noveto().spec.params
    incremental = mod.RbrDbdZonesScalpVix75Noveto()
...
def test_incremental_cache_reprocesses_far_fewer_bars_than_full_recompute() -> None:
    ...
    with pytest.MonkeyPatch.context() as mp:
        ...
        bars_walked.clear()
        cold = mod.RbrDbdZonesScalpVix75Noveto()
